...
class BrushConfig:
    ...
    def get_demo_site_config() -> str:
        desc = (
            "// 以下为配置示例，请参考：https://github.com/InfinityPacer/MoviePilot-Plugins/blob/main/plugins.v2/burshflowplus_v0.1/README.md 进行配置\n"
...
class Burshflowplus_v0_1(_PluginBase):
    # region 全局定义
    ...
    # 插件配置项ID前缀
    plugin_config_prefix = "burshflowplus_v0_1_"
    # 加载顺序
    plugin_order = 22
    # 可使用的用户级别
    auth_level = 2
                                ...
                                'content': [
                                    {
                                        ...
                                        'content': [
                                            ...
                                            },
                                            {
                                                'component': 'a',
                                                'props': {
                                                    'href': 'https://github.com/InfinityPacer/MoviePilot-Plugins/blob/main/plugins.v2/burshflowplus_v0.1/README.md',
                                                    'target': '_blank'
                                                },
                                                'content': [
                                                    {
